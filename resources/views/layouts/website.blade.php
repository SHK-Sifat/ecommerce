...
<!-- Mirrored from html.pixelfit.agency/pesco/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 04 Jan 2025 12:00:29 GMT -->
<head>
        <!--====== Required meta tags ======-->
        <meta charset="utf-8">
        ...
        <link rel="shortcut icon" href="{{ asset("contents/website") }}/{{ asset("contents/website") }}/assets/images/favicon.png" type="image/png">
        ...
        <link rel="stylesheet" href="{{ asset("contents/website") }}/assets/fonts/flaticon/flaticon_pesco.css">
        <link rel="stylesheet" href="{{ asset("contents/website") }}/assets/fonts/fontawesome/css/all.min.css">
        <link rel="stylesheet" href="{{ asset("contents/website") }}/assets/vendor/bootstrap/css/bootstrap.min.css">
        <link rel="stylesheet" href="{{ asset("contents/website") }}/assets/vendor/slick/slick.css">
        <link rel="stylesheet" href="{{ asset("contents/website") }}/assets/vendor/nice-select/css/nice-select.css">
        <link rel="stylesheet" href="{{ asset("contents/website") }}/assets/vendor/magnific-popup/dist/magnific-popup.css">
        <link rel="stylesheet" href="{{ asset("contents/website") }}/assets/vendor/jquery-ui/jquery-ui.min.css">
        <link rel="stylesheet" href="{{ asset("contents/website") }}/assets/vendor/aos/aos.css">
    ...
    <body>
        ...
        <div class="preloader">
            <div class="loader">
                <img src="{{ asset("contents/website") }}/assets/images/loader.gif" alt="Loader">
            </div>
        </div>
        <!--======  Start Overlay  ======-->
                ...
                <div class="container">
                    ...
                    <div class="search-header-inner">
                        ...
                        <div class="site-branding">
                            <a href="index.html" class="brand-logo"><img src="{{ asset("contents/website") }}/assets/images/logo/logo-main.png" alt="Logo"></a>
                        </div>
                        ...
                        <div class="hotline-support item-rtl">
                            ...
                            <div class="info">
                                ...
                                <h5><a href="tel:+8801781-705044">1781-705044</a></h5>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="main-categories-wrap d-none d-lg-block">
                                ...
                                <div class="categories-dropdown-wrap categories-dropdown-active">
                                    <div class="categori-dropdown-item">
                                        <ul>
                                            <li>
                                                <a href="shops.html"> <img src="{{ asset("contents/website") }}/assets/images/icon/shirt.png" alt="Shirts">Man Shirts</a>
                                            </li>
                                            <li>
                                                <a href="shops.html"> <img src="{{ asset("contents/website") }}/assets/images/icon/denim.png" alt="Jeans">Denim Jeans</a>
                                            </li>
                                            <li>
                                                <a href="shops.html"> <img src="{{ asset("contents/website") }}/assets/images/icon/suit.png" alt="Suit">Casual Suit</a>
                                            </li>
                                            <li>
                                                <a href="shops.html"> <img src="{{ asset("contents/website") }}/assets/images/icon/dress.png" alt="Dress">Summer Dress</a>
                                            </li>
                                            <li>
                                                <a href="shops.html"> <img src="{{ asset("contents/website") }}/assets/images/icon/sweaters.png" alt="Sweaters">Sweaters</a>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="more_slide_open">
                                        <div class="categori-dropdown-item">
                                            <ul>
                                                <li>
                                                    <a href="#"><img src="{{ asset("contents/website") }}/assets/images/icon/jacket.png" alt="Jackets">Jackets</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                ...
                                <div class="pesco-nav-menu">
                                    ...
                                    <div class="pesco-tabs style-three d-block d-lg-none">
                                        <ul class="nav nav-tabs mb-30" role="tablist">
                                            <li>
                                                <button class="nav-link active" data-bs-toggle="tab" data-bs-target="#nav1" role="tab">Menu</button>
                                            </li>
                                            <li>
                                                <button class="nav-link" data-bs-toggle="tab" data-bs-target="#nav2" role="tab">Category</button>
                                            </li>
                                        </ul>
                                            ...
                                            <div class="tab-pane fade show active" id="nav1">
                                                <nav class="main-menu">
                                                    <ul>
                                                        ...
                                                        <li class="menu-item has-children"><a href="{{url('/shop')}}">Our Shop</a></li>
                                                        <li class="menu-item has-children"><a href="{{url('/blogs')}}">Our Blog</a> </li>
                                    ...
                                    <nav class="main-menu d-none d-lg-block">
                                        <ul>
                                            ...
                                            <li class="menu-item has-children"><a href="{{url('/shop')}}">Our Shop</a>

                                            </li>
                                            <li class="menu-item has-children"><a href="/blogs">Our Blog</a>
        ...
        <footer class="footer-main">
            ...
            <div class="footer-bg-wrapper gray-bg">
                <div class="footer-shape shape-one"><span><img src="{{ asset("contents/website") }}/assets/images/footer/shape-1.png" alt="shape"></span></div>
                            ...
                            <div class="col-xl-3 col-sm-6">
                                ...
                                <div class="footer-widget about-company-widget mb-40" data-aos="fade-up" data-aos-delay="10" data-aos-duration="1000">
                                    <div class="widget-content">
                                        <a href="index.html" class="footer-logo"><img src="{{ asset("contents/website") }}/assets/images/logo/logo-main.png" alt="Brand Logo"></a>
                                ...
                                <div class="footer-widget footer-nav-widget mb-40" data-aos="fade-up" data-aos-delay="15" data-aos-duration="1200">
                                    <div class="widget-content">
                                        ...
                                        <ul class="widget-menu">
                                            <li><img src="{{ asset("contents/website") }}/assets/images/icon/star-3.svg" alt="star icon"><a href="#">Collections & Delivery</a></li>
                                            <li><img src="{{ asset("contents/website") }}/assets/images/icon/star-3.svg" alt="star icon"><a href="#">Returns & Refunds</a></li>
                                            <li><img src="{{ asset("contents/website") }}/assets/images/icon/star-3.svg" alt="star icon"><a href="#">Terms & Conditions</a></li>
                                            <li><img src="{{ asset("contents/website") }}/assets/images/icon/star-3.svg" alt="star icon"><a href="#">Delivery Return</a></li>
                                            <li><img src="{{ asset("contents/website") }}/assets/images/icon/star-3.svg" alt="star icon"><a href="#">Store Locations</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-3 col-md-6 col-sm-6">
                                ...
                                <div class="footer-widget footer-nav-widget mb-40" data-aos="fade-up" data-aos-delay="20" data-aos-duration="1400">
                                    <div class="widget-content">
                                        ...
                                        <ul class="widget-menu">
                                            <li><img src="{{ asset("contents/website") }}/assets/images/icon/star-3.svg" alt="star icon"><a href="#">Privacy Policy</a></li>
                                            <li><img src="{{ asset("contents/website") }}/assets/images/icon/star-3.svg" alt="star icon"><a href="#">Terms Of Use</a></li>
                                            <li><img src="{{ asset("contents/website") }}/assets/images/icon/star-3.svg" alt="star icon"><a href="#">FAQ</a></li>
                                            <li><img src="{{ asset("contents/website") }}/assets/images/icon/star-3.svg" alt="star icon"><a href="#">Contact</a></li>
                                            <li><img src="{{ asset("contents/website") }}/assets/images/icon/star-3.svg" alt="star icon"><a href="#">Login / Register</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="widget-content">
                                      @foreach($all_blogs as $blog)
                                        <div class="recent-post-item">
                                            ...
                                            <div class="content">
                                                <h4><a href="{{url('/blogs/details/'.$blog->blog_slug)}}">{{$blog->blog_title}}</a></h4>
                                                <span><a href="blog-details.html">{{$blog->created_at}}</a></span>
                                            </div>
                                        </div>
                                        @endforeach
                                    </div>
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-6">
                                <div class="payment-method text-lg-end">
                                    <a href="#"><img src="{{ asset("contents/website") }}/assets/images/footer/payment-method.png" alt="payment-method"></a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <script src="{{ asset("contents/website") }}/assets/vendor/jquery-3.7.1.min.js"></script>
        <script src="{{ asset("contents/website") }}/assets/vendor/popper/popper.min.js"></script>
        <script src="{{ asset("contents/website") }}/assets/vendor/bootstrap/js/bootstrap.min.js"></script>
        <script src="{{ asset("contents/website") }}/assets/vendor/slick/slick.min.js"></script>
        <script src="{{ asset("contents/website") }}/assets/vendor/magnific-popup/dist/jquery.magnific-popup.min.js"></script>
        <script src="{{ asset("contents/website") }}/assets/vendor/nice-select/js/jquery.nice-select.min.js"></script>
        <script src="{{ asset("contents/website") }}/assets/vendor/jquery-ui/jquery-ui.min.js"></script>
        <script src="{{ asset("contents/website") }}/assets/vendor/simplyCountdown.min.js"></script>
        <script src="{{ asset("contents/website") }}/assets/vendor/aos/aos.js"></script>
        <script src="{{ asset("contents/website") }}/assets/js/theme.js"></script>
    </body>

<!-- Mirrored from html.pixelfit.agency/pesco/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 04 Jan 2025 12:00:41 GMT -->
</html>
