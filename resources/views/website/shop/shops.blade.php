...
<main class="main-bg">
  ...
  <section class="shop-page-section pt-120 pb-80">
      <div class="container">
          ...
          @php
          $all_product=App\Models\Product::where('product_status',1)->orderBy('product_id','ASC')->get();
          @endphp
          <div class="shop-page-wrapper">
                  ...
                  <div class="col-xl-4 col-md-6 col-sm-12">
                      ...
                      <div class="product-item style-one mb-40" data-aos="fade-up" data-aos-delay="25" data-aos-duration="400">
                          <div class="product-thumbnail">
                              <img src="{{asset('uploads/product/'.$product->product_image)}}" alt="Products">
                          ...
                          <div class="product-info-wrap">
                              <div class="product-info">
                                  <ul class="ratings rating5">
                                      ...
                                      <li><i class="fas fa-star"></i></li>
                                      <li><i class="fas fa-star"></i></li>
                                      <li><a href="#">({{$product->product_available}})</a></li>
                                  </ul>
                                  <h4 class="title"><a href="{{url('shop/details/'.$product->product_slug)}}">{{$product->product_title}}</a></h4>
                              </div>
              ...
              <div class="row">
                  <div class="col-lg-12">
                      <div class="pesco-pagination text-center mb-40" data-aos="fade-up" data-aos-delay="70" data-aos-duration="2200">
                          <ul>
