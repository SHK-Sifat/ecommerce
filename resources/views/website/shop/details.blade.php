                ...
                <div class="row">
                        ...
                        <div class="product-gallery-area mb-50" data-aos="fade-up" data-aos-duration="1200">
                            <div class="product-big-slider mb-30">
                                <div class="product-img">
                                    <a href="#" class="img-popup"><img src="{{asset('uploads/product/'.$product->product_image)}}" alt="Product"></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-6">
                        <div class="product-info mb-50" data-aos="fade-up" data-aos-duration="1400">
                            <span class="sale"><i class="fas fa-tags"></i>SALE {{$product->product_discount}}</span>
                            ...
                            <ul class="ratings rating5">
                                ...
                                <li><i class="fas fa-star"></i></li>
                                <li><i class="fas fa-star"></i></li>
                                <li><a href="#">({{$product->product_available}} Reviews)</a></li>
                            </ul>
                            <p>{{$product->product_details}}</p>
                            <div class="product-price">
                                <span class="price prev-price"><span class="currency">$</span>{{$product->product_oldprice}}</span>
                                <span class="price new-price"><span class="currency">$</span>{{$product->product_newprice}}</span>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-lg-5">
                            <div class="additional-info-box mb-40">
                                ...
                                <ul>
                                    <li>Fabric type <span>{{$product->product_fabric}}</span></li>
                                    <li>Care instructions:<span>{{$product->product_ctions}}</span></li>
                                    <li>Sleeve type: <span>{{$product->product_sleeve}}</span></li>
                                    <li>Country of Origin<span>{{$product->product_Origin}}</span></li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-lg-7">
                                            ...
                                            <ul>
                                                    ...
                                                    <div class="pesco-reviews-item">
                                                        <div class="author-thumb-info">
                                                            <div class="author-thumb">
                                                                <img src="assets/images/products/review-1.jpg" alt="Auhthor">
                                                            </div>
                                                ...
                                                <li class="comment">
                                                    <div class="pesco-reviews-item">
                                                        <div class="author-thumb-info">
                                                            <div class="author-thumb">
                                                                <img src="assets/images/products/review-2.jpg" alt="Auhthor">
                                                            </div>
                                                            <div class="author-info">
                                                                <h5>Amelia Rodriguez</h5>
                                                                <div class="author-meta">
                                                    ...
                                                    <ul class="reviews-reply">
                                                        <li class="comment">
                                                            <div class="pesco-reviews-item">
                                                                <div class="author-thumb-info">
                                                                    <div class="author-thumb">
                                                                        <img src="assets/images/products/review-3.jpg" alt="Auhthor">
                                                                    </div>
                                                                    <div class="author-info">
                                                                        <h5>Amelia Rodriguez</h5>
                                                                        <div class="author-meta">
