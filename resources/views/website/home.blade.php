...
<main class="main-bg">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="hero-content style-one mb-50">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <img src="{{ asset("contents/website") }}/assets/images/hero/line-1.png" alt="">
                                        </li>
                                        <li>
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="hero-image-box">
                                    <div class="hero-image">
                                        <img src="{{ asset("contents/website") }}/assets/images/hero/hero-one_img1.jpg" alt="Hero Image">
                                        <div class="hero-shape bg_cover" style="background-image: url({{ asset("contents/website") }}/assets/images/hero/hero-one-shape1.png);"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <section class="category-section pt-125 overflow-hidden">
        ...
        @php
        $all_category=App\Models\ProductCategory::where('procate_status',1)->orderBy('procate_id',"ASC")->get();
        @endphp
        <!--=== Category Slider ===-->
        <div class="category-slider-one" data-aos="fade-up" data-aos-delay="20" data-aos-duration="1200">
            ...
            <div class="category-item style-one text-center">
                <div class="category-img">
                    <img src="{{asset('uploads/category/'.$category->procate_image)}}" alt="">
                </div>
                <div class="category-content">
                      <a href="{{url('category/'.$category->procate_url)}}" class="category-btn">{{$category->procate_name}}</a>
                </div>
            </div>
              @endforeach
        </div>
            ...
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <div class="banner-item style-one bg-one mb-40" data-aos="fade-up" data-aos-delay="10" data-aos-duration="900">
                        <div class="shape shape-one"><span><img src="{{ asset("contents/website") }}/assets/images/banner/discount.png" alt="shape"></span></div>
                        <div class="shape shape-two"><span><img src="{{ asset("contents/website") }}/assets/images/banner/line.png" alt="shape"></span></div>
                        <div class="banner-img"><img src="{{ asset("contents/website") }}/assets/images/banner/banner-1.png" alt="banner image"></div>
                ...
                <div class="col-lg-6">
                    ...
                    <div class="banner-item style-one bg-two mb-40" data-aos="fade-up" data-aos-delay="20" data-aos-duration="1100">
                        <div class="shape shape-one"><span><img src="{{ asset("contents/website") }}/assets/images/banner/discount.png" alt="shape"></span></div>
                        <div class="shape shape-two"><span><img src="{{ asset("contents/website") }}/assets/images/banner/line.png" alt="shape"></span></div>
                        <div class="banner-img"><img src="{{ asset("contents/website") }}/assets/images/banner/banner-2.png" alt="banner image"></div>
                        <div class="banner-content">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="pesco-tabs style-one mb-50" data-aos="fade-left" data-aos-delay="15" data-aos-duration="1200">
                        <ul class="nav nav-tabs" role="tablist">
                            ...
                            <li>
                                <button class="nav-link" data-bs-toggle="tab" data-bs-target="#cat3" role="tab">Sold Products</button>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="tab-content" data-aos="fade-up" data-aos-duration="1200">
                        <!--=== Tab Pane  ===-->
                        @php
                        $best_product=App\Models\Product::where('product_status',1)->where('product_type',1)->get();
                        @endphp
                        <div class="tab-pane fade show active" id="cat1">
                            <div class="row justify-content-center">
                              @foreach($best_product as $bproduct)
                                <div class="col-xl-3 col-lg-4 col-sm-6">
                                    <!--=== Product Item  ===-->
                                    <div class="product-item style-one mb-40">
                                        <div class="product-thumbnail">
                                            <img src="{{asset('uploads/product/'.$bproduct->product_image)}}" alt="Products">
                                            <div class="discount">{{$bproduct->product_discount}}</div>
                                        ...
                                        <div class="product-info-wrap">
                                            <div class="product-info">
                                                <ul class="ratings rating5">
                                                    ...
                                                    <li><i class="fas fa-star"></i></li>
                                                    <li><i class="fas fa-star"></i></li>
                                                    <li><a href="#">({{$bproduct->product_available}})</a></li>
                                                </ul>
                                                <h4 class="title"><a href="{{url('shop/details/'.$bproduct->product_slug)}}">{{$bproduct->product_title}}</a></h4>
                                            </div>
                                            <div class="product-price">
                                                <span class="price prev-price"><span class="currency">$</span>{{$bproduct->product_oldprice}}</span>
                                                <span class="price new-price"><span class="currency">$</span>{{$bproduct->product_newprice}}</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="tab-pane fade" id="cat2">
                          @php
                          $new_product=App\Models\Product::where('product_status',1)->where('product_type',2)->get();
                          @endphp
                            <div class="row justify-content-center">
                              @foreach($new_product as $nproduct)
                                <div class="col-xl-3 col-lg-4 col-sm-6">
                                    ...
                                    <div class="product-item style-one mb-40">
                                        <div class="product-thumbnail">
                                            <img src="{{asset('uploads/product/'.$nproduct->product_image)}}" alt="Products">
                                            <div class="discount">{{$nproduct->product_discount}}</div>
                                            <div class="hover-content">
                                                <a href="#" class="icon-btn"><i class="fa fa-heart"></i></a>
                                                <a href="{{ asset("contents/website") }}/assets/images/products/feature-product-2.png" class="img-popup icon-btn"><i class="fa fa-eye"></i></a>
                                            </div>
                                        ...
                                        <div class="product-info-wrap">
                                            <div class="product-info">
                                                <ul class="ratings rating5">
                                                    ...
                                                    <li><i class="fas fa-star"></i></li>
                                                    <li><i class="fas fa-star"></i></li>
                                                    <li><a href="#">({{$nproduct->product_available}})</a></li>
                                                </ul>
                                                <h4 class="title"><a href="{{url('shop/details/'.$nproduct->product_slug)}}">{{$nproduct->product_title}}</a></h4>
                                            </div>
                                            <div class="product-price">
                                                <span class="price prev-price"><span class="currency">$</span>{{$nproduct->product_oldprice}}</span>
                                                <span class="price new-price"><span class="currency">$</span>{{$nproduct->product_newprice}}</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="tab-pane fade" id="cat3">
                          @php
                          $sale_product=App\Models\Product::where('product_status',1)->where('product_type',3)->get();
                          @endphp
                            <div class="row justify-content-center">
                              @foreach($sale_product as $sproduct)
                                <div class="col-xl-3 col-lg-4 col-sm-6">
                                    ...
                                    <div class="product-item style-one mb-40">
                                        <div class="product-thumbnail">
                                            <img src="{{asset('uploads/product/'.$sproduct->product_image)}}" alt="Products">
                                            <div class="discount">{{$sproduct->product_discount}}</div>
                                            <div class="hover-content">
                                                <a href="#" class="icon-btn"><i class="fa fa-heart"></i></a>
                                                <a href="{{ asset("contents/website") }}/assets/images/products/feature-product-2.png" class="img-popup icon-btn"><i class="fa fa-eye"></i></a>
                                            </div>
                                        ...
                                        <div class="product-info-wrap">
                                            <div class="product-info">
                                                <ul class="ratings rating5">
                                                    ...
                                                    <li><i class="fas fa-star"></i></li>
                                                    <li><i class="fas fa-star"></i></li>
                                                    <li><a href="#">({{$sproduct->product_available}})</a></li>
                                                </ul>
                                                <h4 class="title"><a href="{{url('shop/details/'.$sproduct->product_slug)}}">{{$sproduct->product_title}}</a></h4>
                                            </div>
                                            <div class="product-price">
                                                <span class="price prev-price"><span class="currency">$</span>{{$sproduct->product_oldprice}}</span>
                                                <span class="price new-price"><span class="currency">$</span>{{$sproduct->product_newprice}}</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    <section class="features-products-section pt-85 pb-60">
        <div class="container">
            ...
            <!--=== Feature Slider  ===-->
            @php
            $all_product=App\Models\Product::where('product_status',1)->orderBy('product_id',"ASC")->limit(20)->get();
            @endphp
            <div class="feature-slider-one" data-aos="fade-up" data-aos-delay="20" data-aos-duration="1400">
                <!--=== Project Item  ===-->
                @foreach($all_product as $alproduct)
                <div class="product-item style-one mb-40">
                    <div class="product-thumbnail">
                        <img src="{{asset('uploads/product/'.$alproduct->product_image)}}" alt="">
                        <div class="discount">{{$alproduct->product_discount}}</div>
                        <div class="hover-content">
                            <a href="#" class="icon-btn"><i class="fa fa-heart"></i></a>
                    ...
                    <div class="product-info-wrap">
                        <div class="product-info">
                            <ul class="ratings rating4">
                                ...
                                <li><i class="fas fa-star"></i></li>
                                <li><i class="fas fa-star"></i></li>
                                <li><a href="#">({{$alproduct->product_available}})</a></li>
                            </ul>
                            <h4 class="title"><a href="{{url('shop/details/'.$alproduct->product_slug)}}">{{$alproduct->product_title}}</a></h4>
                        </div>
                        <div class="product-price">
                            <span class="price prev-price"><span class="currency">$</span>{{$alproduct->product_oldprice}}</span>
                            <span class="price new-price"><span class="currency">$</span>{{$alproduct->product_newprice}}</span>
                        </div>
                    </div>
                </div>
                @endforeach
    ...
    <section class="best-deal-section">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="offer-deal-wrapper bg_cover" data-aos="fade-up" data-aos-duration="1400" style="background-image: url({{ asset("contents/website") }}/assets/images/bg/deal-bg-1.png);">
                        <div class="deal-img">
                            <span><img src="{{ asset("contents/website") }}/assets/images/banner/deal-1.png" alt="Image"></span>
                        </div>
                                    ...
                                    <div class="author-quote-item d-flex justify-content-between align-items-center">
                                        <div class="author-item">
                                            <div class="author-thumb">
                                                <img src="{{ asset("contents/website") }}/assets/images/testimonial/author-1.png" alt="author image">
                                            </div>
                            ...
                            <div class="testimonial-item style-one mb-40">
                                <div class="testimonial-content">
                                    ...
                                    <div class="author-quote-item d-flex justify-content-between align-items-center">
                                        <div class="author-item">
                                            <div class="author-thumb">
                                                <img src="{{ asset("contents/website") }}/assets/images/testimonial/author-2.png" alt="author image">
                                            </div>
                                            <div class="author-info">
                                                <h5>Rhodes Jhon</h5>
                                                <ul class="ratings rating5">
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="blog-post-item style-one mb-25" data-aos="fade-up" data-aos-duration="1200">
                      @php
                      $article=App\Models\Article::where('article_status',1)->where('article_order',1)->firstOrFail();
                      @endphp
                        <div class="post-thumbnail">
                            <img src="{{asset('uploads/article/'.$article->article_image)}}" alt="Post Thumbnail">
                        </div>
                        <div class="post-content">
                            <h3 class="title"><a href="{{url('/blogs/details/'.$article->article_slug)}}">{{$article->article_title}}</a></h3>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <div class="blog-post-item style-two mb-25" data-aos="fade-up" data-aos-duration="1400">
                              @php
                              $article=App\Models\Article::where('article_status',1)->where('article_order',2)->firstOrFail();
                              @endphp
                                <div class="post-thumbnail">
                                    <img src="{{asset('uploads/article/'.$article->article_image)}}" alt="Post Thumbnail">
                                </div>
                                <div class="post-content">
                                    <h3 class="title"><a href="{{url('/blogs/details/'.$article->article_slug)}}">{{$article->article_title}}</a></h3>
                                    <div class="post-meta">
                                        <span><a href="#">{{$article->article_web}}</a></span>
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="blog-post-item style-two mb-25" data-aos="fade-up" data-aos-duration="1600">
                              @php
                              $article=App\Models\Article::where('article_status',1)->where('article_order',3)->firstOrFail();
                              @endphp
                                <div class="post-thumbnail">
                                    <img src="{{asset('uploads/article/'.$article->article_image)}}" alt="Post Thumbnail">
                                </div>
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="blog-post-item style-two mb-25" data-aos="fade-up" data-aos-duration="1800">
                              @php
                              $article=App\Models\Article::where('article_status',1)->where('article_order',4)->firstOrFail();
                              @endphp
                                <div class="post-thumbnail">
                                    <img src="{{asset('uploads/article/'.$article->article_image)}}" alt="Post Thumbnail">
                                </div>
                        ...
                        <div class="col-sm-6">
                            <div class="blog-post-item style-two mb-25" data-aos="fade-up" data-aos-duration="2000">
                              @php
                              $article=App\Models\Article::where('article_status',1)->where('article_order',5)->firstOrFail();
                              @endphp
                                <div class="post-thumbnail">
                                    <img src="{{asset('uploads/article/'.$article->article_image)}}" alt="Post Thumbnail">
                                </div>
