    ...
    <section class="blog-section pb-80">
        <div class="container">
            ...
            <div class="blogs-wrapper">
                <div class="row">
                  @php
                  $all_blogs=App\Models\Blog::where('blog_status',1)->orderBy('blog_id','ASC')->get();
                  @endphp
                    <div class="col-xl-8">
                        <!--=== Blog Post Item ===-->
                        ...
                        <div class="blog-post-item style-four" data-aos="fade-up" data-aos-duration="1400">
                            ...
                            <div class="post-content">
                                <h3 class="title"><a href="{{url('/blogs/details/'.$blog->blog_slug)}}">{{$blog->blog_title}}</a></h3>
                                <p>{{$blog->blog_subtitle}}</p>
                                <div class="post-meta">
                                    <span><a href="#">{{$blog->blog_web}}</a></span>
                    ...
                    <div class="col-xl-4">
                        <div class="sidebar-widget-area">
                            <!--=== Sidebar Widget ===-->
                            <div class="sidebar-banner-widget mb-40" data-aos="fade-up" data-aos-duration="1000">
                                <div class="banner-widget-content">
                                    <div class="banner-shape"><img src="{{ asset("contents/website") }}/assets/images/widget/banner-shape-1.png" alt="shape"></div>
                                    <div class="banner-img"><img src="{{ asset("contents/website") }}/assets/images/widget/banner-1.png" alt="image"></div>
                                    <div class="content">
                            ...
                            <!--=== Sidebar Widget ===-->
                            <div class="sidebar-newsletter-widget mb-40" data-aos="fade-up" data-aos-duration="1200">
