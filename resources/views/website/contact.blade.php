            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="single-information-wrapper">
                      @php
                      $contact=App\Models\Contact::where('contact_status',1)->where('contact_country','Australia')->firstOrFail();
                      @endphp
                        <div class="single-information-item d-flex justify-content-between mb-15" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="50">
                            ...
                            <div class="content mb-20">
                                <h4>Phone</h4>
                                <p><a href="tel:+011234567890">{{$contact->contact_phone1}}</a></p>
                                <p><a href="tel:+011234567890">{{$contact->contact_phone2}}</a></p>
                            </div>
                            <div class="content mb-20">
                                <h4>Email</h4>
                                <p><a href="mailto:sifatk436@gmail.com">{{$contact->contact_email}}</a></p>
                            </div>
                        </div>
                        @php
                        $contact=App\Models\Contact::where('contact_status',1)->where('contact_country','England')->firstOrFail();
                        @endphp
                        <div class="single-information-item d-flex justify-content-between mb-15" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="70">
                            <div class="content mb-20">
                        ...
                        @php
                        $contact=App\Models\Contact::where('contact_status',1)->where('contact_country','Canada ')->firstOrFail();
                        @endphp
                        <div class="single-information-item d-flex justify-content-between mb-15" data-aos="fade-up" data-aos-duration="1400" data-aos-delay="90">
                            <div class="content mb-20">
                                <h4>Canada Office:</h4>
                                <p>{{$contact->contact_address}}</p>
                            </div>
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="contact-wrapper p-r z-1 mb-50" data-aos="fade-right" data-aos-delay="10" data-aos-duration="1000">
                        <div class="shape shape-one"><span><img src="{{ asset("contents/website") }}/assets/images/shape/cl-line.png" alt="Line Shape"></span></div>
                        <h3>Get in touch</h3>
                        <form class="pesco-contact-form" method="post" action="{{url('contact/review/submit')}}">
                            @csrf
                            <div class="row">
                                <div class="col-lg-6">
                ...
                <div class="col-lg-4">
                    <div class="contact-img-text text-center mb-50 d-none d-lg-block" data-aos="fade-left" data-aos-delay="15" data-aos-duration="1500">
                        <img src="{{ asset("contents/website") }}/assets/images/contact/text-img.png" alt="Text">
                    </div>
                </div>
            </div>
        </div>
