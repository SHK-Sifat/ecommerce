...
@section('content')
@php
  $cateID=$cate->procate_id;
  $all=App\Models\Product::where('product_status',1)->where('product_categori',$cateID)->orderBy('product_id','DESC')->get();
@endphp
<main class="main-bg">
                            ...
                            <div class="col-xl-4 col-md-6 col-sm-12">
                                ...
                                <div class="product-item style-one mb-40" data-aos="fade-up" data-aos-delay="25" data-aos-duration="400">
                                    <div class="product-thumbnail">
                                        <img src="{{asset('uploads/product/'.$data->product_image)}}" alt="Products">
                                        <div class="discount">{{$data->product_discount}}</div>
                                    ...
                                    <div class="product-info-wrap">
                                        <div class="product-info">
                                            <ul class="ratings rating5">
                                                ...
                                                <li><i class="fas fa-star"></i></li>
                                                <li><i class="fas fa-star"></i></li>
                                                <li><a href="#">({{$data->product_available}})</a></li>
                                            </ul>
                                            <h4 class="title"><a href="{{url('shop/details/'.$data->product_slug)}}">{{$data->product_title}}</a></h4>
                                        </div>
                                        <div class="product-price">
                                            <span class="price prev-price"><span class="currency">$</span>{{$data->product_oldprice}}</span>
                                            <span class="price new-price"><span class="currency">$</span>{{$data->product_newprice}}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
