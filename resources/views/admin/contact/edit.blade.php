            ...
            <div class="card mb-3">
              <div class="card-header">
                <div class="row">
                    <div class="col-md-8 card_title_part">
                        <i class="fab fa-gg-circle"></i>Contact Update
                    </div>
              ...
              <div class="card-body">
                  ...
                  <div class="row mb-3 {{ $errors->has('contact_address') ? ' has-error' : '' }}">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control form_control" id="" name="contact_address" value="{{$data->contact_address}}">
                  ...
                  <div class="row mb-3{{ $errors->has('contact_phone1') ? ' has-error' : '' }}">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control form_control" id="" name="contact_phone1" value="{{$data->contact_phone1}}">
                  ...
                  <div class="row mb-3">
                    ...
                    <input type="hidden" name="slug" value="{{$data->contact_slug}}">
                    <input type="hidden" name="id" value="{{$data->contact_id}}">-
                    <div class="col-sm-7">
                      <input type="text" class="form-control form_control" id="" name="contact_phone2" value="{{$data->contact_phone2}}">
                    </div>
                  </div>
                  <div class="row mb-3 {{ $errors->has('contact_email') ? ' has-error' : '' }}">
                    <label class="col-sm-3 col-form-label col_form_label">Email<span class="req_star">*</span>:</label>
                    <div class="col-sm-7">
                      <input type="email" class="form-control form_control" id="" name="contact_email" value="{{$data->contact_email}}">
                  ...
                  <div class="row mb-3 {{ $errors->has('contact_country') ? ' has-error' : '' }}">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control form_control" id="" name="contact_country" value="{{$data->contact_country}}">
