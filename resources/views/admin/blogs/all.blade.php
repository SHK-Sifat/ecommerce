          ...
          <div class="card-header">
            <div class="row">
                <div class="col-md-8 card_title_part">
                    <i class="fab fa-gg-circle"></i>All Blogs Information
                </div>
                <div class="col-md-4 card_button_part">
                    <a href="{{url('dashboard/blogs/add')}}" class="btn btn-sm btn-dark"><i class="fas fa-plus-circle"></i>Add Blogs</a>
                </div>
            </div>
          </div>
          <div class="card-body">
            ...
            <table class="table table-bordered table-striped table-hover custom_table">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    @if($data->blog_image!='')
                      <img class="" height="40px" src="{{asset('uploads/blogs/'.$data->blog_image)}}"/>
                    @else
                  ...
                  <td>
                      <div class="btn-group btn_group_manage" role="group">
                        ...
                        <ul class="dropdown-menu">
                          <li><a class="dropdown-item" href="{{url('dashboard/blogs/view/'.$data->blog_slug)}}">View</a></li>
                          <li><a class="dropdown-item" href="{{url('dashboard/blogs/edit/'.$data->blog_slug)}}">Edit</a></li>
                        <a class="dropdown-item" href="{{url('dashboard/blogs/softdelete/'.$data->blog_id)}}">Delete</a>
                        </ul>
                      </div>
                  </td>
                </tr>
