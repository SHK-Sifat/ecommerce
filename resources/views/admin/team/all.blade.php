          ...
          <div class="card-header">
            <div class="row">
                ...
                <div class="col-md-4 card_button_part">
                    <a href="{{url('dashboard/team/add')}}" class="btn btn-sm btn-dark"><i class="fas fa-plus-circle"></i>Add TEam Member</a>
                </div>
            </div>
          </div>
          <div class="card-body">
            ...
            <table class="table table-bordered table-striped table-hover custom_table">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>{{$data->team_instagram}}</td>
                  <td>{{$data->team_twitter}}</td>
                  <td>
                    @if($data->team_image!='')
                      <img class="" height="40px" src="{{asset('uploads/team/'.$data->team_image)}}"/>
                    @else
                  ...
                  <td>
                      <div class="btn-group btn_group_manage" role="group">
                        ...
                        <ul class="dropdown-menu">
                          <li><a class="dropdown-item" href="{{url('dashboard/team/view/'.$data->team_slug)}}">View</a></li>
                          <li><a class="dropdown-item" href="{{url('dashboard/team/edit/'.$data->team_slug)}}">Edit</a></li>
                          <li><a class="dropdown-item" href="{{url('dashboard/team/softdelete/'.$data->team_id)}}">Delete</a></li>
                        </ul>
                      </div>
                  </td>
                </tr>
