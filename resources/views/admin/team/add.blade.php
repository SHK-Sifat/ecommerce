...
<div class="row">
    <div class="col-md-12 ">
        <form method="post" action="{{url('dashboard/team/submit')}}" enctype="multipart/form-data">
          @csrf
            <div class="card mb-3">
              ...
              <div class="card-body">
                  ...
                  <div class="row mb-3 {{ $errors->has('team_name') ? ' has-error' : '' }}">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control form_control" id="" name="team_name" value="{{old('team_name')}}">
                  ...
                  <div class="row mb-3 {{ $errors->has('team_title') ? ' has-error' : '' }}">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control form_control" id="" name="team_title" value="{{old('team_title')}}">
                  ...
                  <div class="row mb-3 {{ $errors->has('team_facebook') ? ' has-error' : '' }}">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control form_control" id="" name="team_facebook" value="{{old('team_facebook')}}">
                  ...
                  <div class="row mb-3 {{ $errors->has('team_linkedin') ? ' has-error' : '' }}">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control form_control" id="" name="team_linkedin" value="{{old('team_linkedin')}}">
                  ...
                  <div class="row mb-3 {{ $errors->has('team_instagram') ? ' has-error' : '' }}">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control form_control" id="" name="team_instagram" value="{{old('team_instagram')}}">
                  ...
                  <div class="row mb-3 {{ $errors->has('team_twitter') ? ' has-error' : '' }}">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control form_control" id="" name="team_twitter" value="{{old('team_twitter')}}">
